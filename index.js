...
function getFloatingNavItems(resume) {
    var floating_nav_items = [
        {label: 'Sobre', target: 'about', icon: 'board', requires: 'basics.summary'},
        {label: 'Experiência Profissional', target: 'work-experience', icon: 'office', requires: 'work'},
        {label: 'Skills', target: 'skills', icon: 'tools', requires: 'skills'},
        {label: 'Educação', target: 'education', icon: 'graduation-cap', requires: 'education'},
        {label: 'Prêmios', target: 'awards', icon: 'trophy', requires: 'awards'},
        {label: 'Trabalho Voluntário', target: 'volunteer-work', icon: 'child', requires: 'volunteer'},
        {label: 'Publicações', target: 'publications', icon: 'newspaper', requires: 'publications'},
        {label: 'Interesses', target: 'interests', icon: 'heart', requires: 'interests'},
        {label: 'Referências', target: 'references', icon: 'thumbs-up', requires: 'references'}
    ];
